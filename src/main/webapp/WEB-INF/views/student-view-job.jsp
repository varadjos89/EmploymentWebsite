...
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
  ...
  <tr>
     <td><b>Openings</b></td>
     <td><c:out value="${jobs.openings}"/></td>
  <tr>
  <tr>
     <td><b>Term</b></td>
     <td><c:out value="${jobs.term}"/></td>
  <tr>
  <tr>
     <td><b>Length</b></td>
     <td><c:out value="${jobs.length}"/></td>
  <tr>
  <tr>
     <td><b>Location</b></td>
     <td><c:out value="${jobs.location}"/></td>
  <tr>
  <tr>
     <td><b>Job Description</b></td>
     <td><c:out value="${jobs.description}"/></td>
  <tr>
  <tr>
     <td><b>Minimum Wage</b></td>
     <td><c:out value="${jobs.wage}"/></td>
  <tr>
  <tr>
     <td><b>Add Resume</b></td>
     <td><input type="file" name="name" required="required"></td>
  <tr>
  </table><br>
  <c:choose>
    ...
    <c:otherwise>
        <input type="button" class="button" value="Apply" onclick="onSubmit();"/>
    </c:otherwise>
  </c:choose>
  </form>
  </div>
