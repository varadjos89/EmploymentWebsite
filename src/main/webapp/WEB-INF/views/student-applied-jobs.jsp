         ...
         <div class="container">
             ...
             <tr>
                ...
                <td><b>Deadline</b></td>
                    ...
                    for(Application ap:appliedJobs)
                    {
                    %>
                    <tr>
                    <td><form method="post" action="${contextPath}/student/view/applied/job.htm?id=<%=ap.getId()%>">
			          <input type="submit" value="View" class="button">
			          </form>
			        </td>
                    <td><%=ap.getJob().getTerm()%></td>
                    <td><%=ap.getJob().getTitle()%></td>
                    <td><%=ap.getJob().getOrganization()%></td>
                    <td><%=ap.getJob().getLocation()%></td>
                    <td><%=ap.getJob().getDate().toString()%></td>
                    </tr> 
                   <% }%> 
            </table>
         </div>
