         ...
         <div class="container">
             ...
             <fmt:formatDate value="${job.date}" var="formattedDate" 
                ...
                <tr>
                    ...
                    <td><c:out value="${application.student.name}"/></td>
                    <td><c:out value="${application.student.email}"/></td>
				    ...
				    <c:when test="${application.status eq 'shortlisted'}">
				        <input type="submit" class="button" value="shortlisted" style="color:red" disabled/>
				    </c:when>
				    <c:otherwise>
